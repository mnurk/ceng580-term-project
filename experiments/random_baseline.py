...
def run_random_episode(verbose=False, env_class=PipelineEnv):
...
if __name__ == "__main__":
    print("Single random episode:")
    single_result = run_random_episode(verbose=True)
    print("Random Result:", single_result)

    print("\nRandom experiment:")
    summary, _ = run_random_experiment(num_episodes=100)
    print("Random Summary:", summary)
